...
export const contentQueryOptions = (contentId: string, contentType?: ContentTypes) =>
    queryOptions({
...
export const Route = createFileRoute('/content/$id')({
    ...
    loader: ({ params: { id }, deps: { contentType } }) => contentQueryOptions(id, contentType),
...
function ContentComponent() {
    ...
    const updateContent = useEntityUpdate(content.type, (id, data) =>
        contentApi.update(id, { ...data, type: content?.type ?? contentType ?? ContentTypes.TERM })
    );
